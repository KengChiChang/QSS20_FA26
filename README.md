...
repository to get each week's files.

## What you need first

- Git installed, and a GitHub account with access to this repository.
...
```bash
cp activity_solutions/lec02_activity.ipynb my_lec02_activity.ipynb
```
...
- `public_data/`: shared datasets used in class and on problem sets
- `problemsets/`: problem set files
